...
Outra forma de organizar o script e o trabalho realizado por ele é definir o diretório de trabalho (_working directory_) que será utilizado pelo R para importar/exportar arquivos. É possível perguntar ao R qual o diretório atual de trabalho. As funções são bem intuitivas: _getwd_ (diretório atual) e _setwd_ (definir diretório)
