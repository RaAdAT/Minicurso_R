...
Até agora, só foram apresentados objetos que sejam vetores atômicos. Ainda, todos eles de *classe* númerica. Há, entretanto, três classes principais de vetores atômicos:
...
logico <- TRUE
```
É possível examinar a classe de cada um dos objetos com a função _class_:
