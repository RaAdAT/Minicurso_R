...
```
Note que a função _quantile_ requer um segundo argumento que indica os quantis a serem reportados. Caso não indiquem o segundo argumento "_probs_", serão reportados os seguintes quantis: 0%, 25%, 50%, 75% e 100%.
