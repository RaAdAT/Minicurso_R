...
É possível listar os objetos até então criados com a função _ls()_:

```{r}
ls()
```

Até agora, só foram apresentados objetos que sejam vetores atômicos. Ainda, todos eles de classe númerica. Há 
