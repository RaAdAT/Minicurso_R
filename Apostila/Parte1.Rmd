...
A interface do RStudio é separada em quatro "janelas". A janela superior à esquerda é o  
...
Outra forma de organizar o script e o trabalho realizado por ele é definir o diretório de trabalho (_working directory_) que será utilizado pelo R para importar/exportar arquivos. É possível também perguntar ao R qual o diretório atual de trabalho. As funções são bem intuitivas: _getwd_ (diretório atual) e _setwd_ (definir diretório)
...
quadrado(10)
```
Note que a função é definida como um objeto, em que o nome do objeto será o nome da função. O argumento da função fica entre parênteses e o corpo da função fica entre chaves. É útil pensar as funções do R como as do ensino básico:

![](http://bit.ly/2tGGakw) ou ![](http://bit.ly/2tGGik0)
