...
As operações matemáticas apresentadas acima são funções dentro do R. Para que fique claro, abaixo está a mesma suma, mas agora com a função explícita (entre crases):
