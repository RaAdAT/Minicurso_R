...
Nesse caso, a variável `x` tem uma distribuição normal padrão. Note que o código foi encurtado e que ainda assim o R ainda entende o que foi escrito. É possível verificar o resultado com a função nativa do R para a densidade da normal padrão: 
