...
quadrado(10)
```
Note que a função é definida como um objeto, em que o nome do objeto será o nome da função. O argumento da função fica entre parênteses e o corpo da função fica entre chaves. É utlizado o "_return_" para definir o valor a ser apresentado pelo R.
