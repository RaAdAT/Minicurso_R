...
O **_readr_** é reponsável pela leitura de arquivos em formato "retangular" (csv, tsv, txt, etc.). Algumas de suas funções são (há 7 no total):

- **read_csv()**: arquivos csv (comma separated files)
...
Para fins do minicurso, será utilizado um exemplo com um arquivo .csv, mas o exemplo é facilmente transbordado para outras extensões. Eis o exemplo, com dados de 
