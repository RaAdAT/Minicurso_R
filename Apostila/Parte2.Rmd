...
```{r}
url_munic <- "https://github.com/RaAdAT/Minicurso_R/blob/master/Base_MUNIC_2015.xls"
url_finbra  <- "https://github.com/RaAdAT/Minicurso_R/blob/master/despesa_natureza.csv"
```
...
```{r}
download.file(url_finbra, Base_MUNIC_2015.xls)
